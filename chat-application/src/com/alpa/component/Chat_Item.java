...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/alpa/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/alpa/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.alpa.swing.JIMSendTextPane();
    ...
    private com.alpa.swing.JIMSendTextPane txt;
